...
const saveFullNameInDB = (firstName, lastName, ...additionals) => {
  ...
  saveAdditionals(additionals); // Благодаря rest оператору мы смогли собрать все дополнительные данные, которые были переданы для сохранения в базе данных, и можем передать их одним массивом в функцию сохранения дополнительных данных.
};
